...
#
#------------------------------------------------------------------------------
# SERVICE METADATA - DEPRECATED (configs now generated by install script)
#------------------------------------------------------------------------------

SERVICE_NAME="OTel Monitoring (Manual)"
SERVICE_DESCRIPTION="[DEPRECATED] Manual start script - use 'dev-services' instead"
