...
#
# ⚠️  IMPORTANT: This script is now OPTIONAL for manual/debugging use.
# ⚠️  OTel services are managed by supervisord automatically.
#
# Primary Method (Recommended):
#   dev-services start              # Start all services via supervisord
#   dev-services status             # Check service status
#   dev-services logs otel-metrics  # View service logs
#
# Manual Method (This Script - for debugging):
...
#
# Note: Services installed via install-otel-monitoring.sh are automatically
#       configured for supervisord and will start on container boot.
#
#------------------------------------------------------------------------------
...
SERVICE_DESCRIPTION="OpenTelemetry monitoring stack (lifecycle, metrics, script exporter)"
...
# Note: This script no longer uses supervisord metadata.
# Supervisor configs are generated directly by install-otel-monitoring.sh
...
main() {
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "⚠️  Manual Start Script (Debugging/Legacy Mode)"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    log_warn "This manual start method is for debugging purposes only."
    echo ""
    echo "Recommended method:"
    echo "  dev-services start    # Start all services via supervisord"
    echo "  dev-services status   # Check service status"
    echo ""
    echo "Services installed via install-otel-monitoring.sh are"
    echo "automatically managed by supervisord and start on boot."
    echo ""
    echo "Press Ctrl+C to cancel, or wait 5 seconds to continue with manual start..."
    sleep 5
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "🚀 Starting OpenTelemetry Monitoring Services (Manual Mode)"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
