#!/bin/bash
# Supervisord wrapper for OTel Metrics Collector
...
CONFIG_FILE="/workspace/.devcontainer/additions/otel/otelcol-metrics-config.yaml"
LOG_FILE="/var/log/otelcol-metrics.log"
...
echo "Starting OTel Metrics Collector..."
